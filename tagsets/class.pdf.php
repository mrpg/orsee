 ...
 class Cpdf
{
     ...
     * @return void
     */
    //ORSEE: public function __construct($pageSize = array(0, 0, 612, 792), $isUnicode = false)
    public function __construct($pageSize = array(0, 0, 612, 792), $isUnicode = true)
    {
